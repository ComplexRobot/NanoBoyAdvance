...
struct CgbChannel
{
    ...
    u32 track;
    u32 prevChannelPointer;
    u32 nextChannelPointer;
    u8 dummy4[8];
};
...
typedef u32 MPlayFunc;
typedef u32 PlyNoteFunc;
typedef u32 CgbSoundFunc;
typedef u32 CgbOscOffFunc;
typedef u32 MidiKeyToCgbFreqFunc;
typedef u32 ExtVolPitFunc;
typedef u32 MPlayMainFunc;
